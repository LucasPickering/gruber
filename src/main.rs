        ...
        match message {
            ...
            Message::TabClosed(index) => {
                ...
                self.active_tab = if self.tabs.is_empty() {
                    ...
                    usize::max(
                        0,
                        usize::min(self.active_tab, self.tabs.len() - 1),
                    )
                };
        ...
        Column::new()
            .push(
                Row::new()
                    ...
                    .push(
                        Button::new(Text::new("New")).on_press(Message::NewTab),
                    )
                ...
                self.tabs
                    ...
                    .fold(
                        ...
                        |tab_bar, (tab_label, _)| {
                            ...
                            tab_bar
                                .push(idx, TabLabel::Text(tab_label.to_owned()))
                        },
                    )
